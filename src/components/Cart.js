...
const Cart = (props) => {
  ...
  const handleToken = async (token) => {
    ...
    if (status === "success") {
      ...
      props.history.push("/");
      toast.success(
        " Congratulations!! You have Successfully paid. You can continue your Shopping.",
        ...
        <div className="cart-summary">
          <div className="summary">
            ...
            <div className="stripe-section">
              <StripeCheckout
                stripeKey="pk_test_51HRDpmGUXdZJSMBr5AR80j14tbyK5pKYelhM8nxlW9kMssS79PVzISkDlWOQiNhtZapXutcgEnBDVJozstGN3Lzr00aunT8RAJ"
                token={handleToken}
                billingAddress
                shippingAddress
